...
<br>
  ...
  <div class="card card-primary"><!-- card card-gray -->
      <div class="card-header ">
        <h3 class="card-title">จัดการงานวิจัย</h3>
              ...
              <table id="example1" class="table table-head-fixed text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="user_list_thesis_db.php?thesis_id=<?php echo $row_thesis['thesis_id']; ?>&&thesis=status&&thesis_status=0" class="btn btn-danger"><i class=""></i>ระงับการเผยแพร่/ให้แก้ไข</a>
                    </td> 
